...
Error update failed: You did not supply a value for binding parameter :id.
(7,
 'nxos \n',
 '  NXOS: version 10.3(3) [Feature Release]\n',
...
'
```
I disabled the delete function in the script to show what the data looks like in the DB.
Running it again.
```
pi@rasp4:~/Coding/python_folder/misc/netwk_db $ python3.12 add_remove_device.py 
Enter host device: sandbox-nxos-1.cisco.com
...
```
pi@rasp4:~/Coding/python_folder/misc/netwk_db $ cat netdb.sql 
?I???IP++Ytablesqlite_sequencesqlite_sequenceCREATE TABLE sqlite_sequence(name,seq)?|OtabledevicesdevicesCREATE TABLE devices (
    ...
    config TEXT,
    last_updated DATETIME DEFAULT CURRENT_TIMESTAMP
zaW?]3nxos te_autoindex_devices_2devices-Andexsqlite_autoindex_devices_1devices
  NXOS: version 10.3(3) [Feature Release]
  Internet Address is 10.10.20.95/24
...
2025-08-03 14:03:12p#{3router1IOS-XE 17.3.4192.168.1.1interface Gig0/0\n ip address 192.168.1.1 255.255.255.02025-08-02 19:10:46
???
nxos 

	router1
???I)W  Internet Address is 10.10.20.95/24
??      192.168.1.1
  evicepi@rasp4:~/Coding/python_folder/misc/netwk_db $
```
